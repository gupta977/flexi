...
add_action("wp_ajax_flexi_ajax_post_update_image", "flexi_ajax_post_update_image");
add_action("wp_ajax_nopriv_flexi_ajax_post_update_image", "flexi_my_must_login");
...
function flexi_ajax_post_update_image()
{
    flexi_log("am hreeee");
    if (
    ...
    if ('flexi' == $upload_type) {
        ...
        $result = flexi_update_primary_image($files, $flexi_id);
...
function flexi_update_primary_image($files, $flexi_id)
{
    flexi_log($files);
}
